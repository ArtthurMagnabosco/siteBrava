...
import implantacaoPhoto from "../../../../public/assets/imagens/fotos/implantacaoDesk.png";
import reestruturacaoPhoto from "../../../../public/assets/imagens/fotos/reestruturacaoDesk.png";
import aceleracaoPhoto from "../../../../public/assets/imagens/fotos/aceleracaoDesk.png";
import cursosInCompanyPhoto from "../../../../public/assets/imagens/fotos/cursosInCompanyDesk.png";
import diagnosticoPhoto from "../../../../public/assets/imagens/fotos/diagnosticoDesk.png";
        ...
        <div className="modelos-negocio">
          ...
          <div className="modelos__cardrow">
            <div className="modelos__card">
              <Image className="modelos__header__img" src={B2CIcon} alt="" />
            ...
            <div className="modelos__card">
              <Image className="modelos__header__img" src={D2CIcon} alt="" />
              <h4 className="modelos__header__text">
            ...
            <div className="modelos__card">
              <Image className="modelos__header__img" src={B2BIcon} alt="" />
              <h4 className="modelos__header__text">
            ...
            <div className="modelos__card">
              <Image className="modelos__header__img" src={inOutIcon} alt="" />
