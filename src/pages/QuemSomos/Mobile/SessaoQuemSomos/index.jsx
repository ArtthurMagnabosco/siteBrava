import './sass/SessaoQuemSomos.scss'
        ...
        <div className='quem-somos__container'>
            ...
            <div className='quem-somos__body'>
                <div className='body__company'>
                    ...
                    <p className='body__company__text'>Especializada em implantação, diagnóstico e evolução de projetos de e-commerce e marketplace.</p>
                    </div>
                ...
                <div className='body__company'>
                    ...
                    <p className='body__company__text'>Cursos in company para o mercado de e-commerce, marketplace e marketing digital</p>
                    </div>
                ...
                <div className='body__company'>
                    ...
                    <p className='body__company__text'>Certificada em implantação, migração e suporte da plataforma VTEX</p>
                    </div>
...
export default SessaoQuemSomos;